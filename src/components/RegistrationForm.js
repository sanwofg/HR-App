...
// justify between
  return (
    ...
    <div className="text-black text-lg font-semibold mt-11 max-md:max-w-full max-md:mt-10">
      Full Name (as it appears in your documents)
        <input className={`w-full items-center border flex shrink-0 h-[44px] flex-col max-md:max-w-full mt-2 pl-5 rounded-xl ${fullNameError ? 'border-red-500' : 'border-solid border-green-700'}`}
          type="text" 
          value={fullName} 
      ...
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="items-stretch grow flex flex-col max-md:max-w-full lg:w-1/2 max-md:mt-6">
            ...
            <div className="items-stretch border flex justify-between h-[44px] gap-0 mt-2 px-6 py-2 rounded-xl border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5">
              <div className="text-blacktext-lg grow">{}
          ...
          <div className="items-stretch grow flex flex-col max-md:max-w-full lg:w-1/2 max-md:mt-6">
            ...
            <div 
              className="items-stretch border flex h-[44px] justify-between gap-0 mt-2 px-6 py-1.5 rounded-2xl border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5"
    ...
    <div className="mt-2 max-md:max-w-full">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="items-stretch grow flex flex-col max-md:max-w-full lg:w-1/2 max-md:mt-6">
            ...
            <input 
              className={`text-black text-lg justify-center border mt-2 pl-6 py-2 h-[44px] rounded-xl border-solid ${
          ...
          <div className="items-stretch flex grow flex-col max-md:max-w-full max-md:mt-6 lg:w-1/2">
            ...
            <input className="justify-center pl-6 pr-16 py-2 items-start border flex shrink-0 h-[44px] flex-col mt-2 rounded-xl border-solid border-green-700 max-md:max-w-full" 
              type="number"
              value={nin}
    ...
    <div className="items-stretch flex justify-between gap-5 mt-6 h-[44px] max-md:max-w-full max-md:flex-wrap">
      {/* Apartment Field */}
     ...
     {/* City/Town Field */}
    <input className="text-black text-lg justify-center items-stretch border mt-6 px-6 py-2 rounded-xl border-solid border-green-700 max-md:max-w-full max-md:px-5"
      type="text"
    ...
    <div className="items-stretch flex justify-between gap-5 mt-6 max-md:max-w-full max-md:flex-wrap">
      ...
      <div className="flex items-stretch border h-[44px] justify-between gap-0 mt-2 px-6 py-2 rounded-xl border-solid border-green-700 w-full max-md:max-w-full max-md:flex-wrap lg:w-1/2 max-md:px-5">
      {/* items-stretch border flex justify-between gap-0 mt-2 px-6 py-6 rounded-2xl border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5" */}
        <input 
          type="text"
          placeholder="LGA"
      ...
      <div className=" items-stretch border flex justify-between gap-0 h-[44px] mt-2 px-6 py-2 rounded-xl border-solid border-green-700 w-full max-md:max-w-full max-md:flex-wrap lg:w-1/2 max-md:px-5">
    ...
    <div className="justify-between items-stretch border h-[44px] flex gap-0 mt-6 px-6 py-2 rounded-xl border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5"
    ...
    <div className="items-stretch border flex flex-col justify-center mt-2 px-6 py-3.5 rounded-2xl border-solid border-green-700 max-md:max-w-full max-md:px-5">
      <div className="items-stretch border flex justify-between gap-2.5 rounded-xl border-solid border-green-700 max-md:max-w-full max-md:flex-wrap">
    ...
    <div 
      className="justify-between items-stretch border flex gap-0 mt-2 px-6 py-1.5 rounded-xl h-[44px] border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5"
    ...
    <div className="justify-between items-stretch border flex gap-0 mt-2 px-6 py-1.5 rounded-xl h-[44px] border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5"
    ...
    <div className="justify-center border flex mt-2 pl-6 pr-6 py-1.5 rounded-xl h-[44px] border-solid border-green-700 items-end max-md:max-w-full max-md:px-5"
    ...
    <input className="text-black text-lg items-stretch border mt-2 pt-1.5 pb-24 px-6 rounded-2xl border-solid border-green-700 max-md:max-w-full max-md:pb-10 max-md:px-5"
    ...
    <div className="items-stretch border flex justify-between gap-0 px-6 py-1.5 h-[44px] rounded-xl border-solid border-green-700 max-md:max-w-full max-md:flex-wrap max-md:px-5"
