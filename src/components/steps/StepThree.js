      ...
      <div className="items-stretch border flex flex-col px-2 rounded-xl mt-2 border-solid border-[#388e3c] max-md:max-w-full max-md:px-5">
        <form>
          ...
          <div className="items-stretch border flex justify-between pl-1 py-1 rounded-l border-solid border-[#388e3c] max-md:max-w-full max-md:flex-wrap">
            <input className="text-[#000000] text-start text-italic text-lg grow my-auto max-sm:text-xs max-md:max-w-full" type="file" />
          </div>
          ...
          <div className="mb-2">
            ...
            <div className="items-stretch border flex justify-between pl-1 py-1 rounded-l border-solid border-[#388e3c] max-md:max-w-full max-md:flex-wrap">
              <input className="text-[#000000] italics text-start text-lg grow my-auto max-sm:text-xs max-md:max-w-full" type="file" />
            </div>
          </div>
        </form>
      </div>
...
<div className="items-stretch grow flex flex-col max-md:max-w-full lg:w-full max-sm:mt-1 max-md:mt-2">
  ...
  <div className='relative'>
    ...
    {isPreferredCourseDropdownOpen && (
      <div className="absolute flex flex-col mt-2 max-sm:text-sm max-sm:mt-1 w-full bg-[#ffffff] border border-solid border-[#388e3c] rounded-md">
